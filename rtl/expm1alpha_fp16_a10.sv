...
// SystemVerilog created from expm1alpha_a10_vlog
// SystemVerilog created on Mon Oct 22 17:44:14 2018


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module expm1alpha_fp16_a10 (
    input wire [15:0] x,
    input wire [15:0] a,
    output wire [15:0] q,
    input wire clk,
    ...
    wire [0:0] expAlphaZ_uid84_fpExpEM1Test_qi;
    reg [0:0] expAlphaZ_uid84_fpExpEM1Test_q;
    ...
    wire [0:0] udf_uid93_fpExpEM1Test_qi;
    reg [0:0] udf_uid93_fpExpEM1Test_q;
    ...
    reg [0:0] redist0_outSign_uid99_fpExpEM1Test_q_11_q;
    reg [4:0] redist1_expHalfPreUdf_uid95_fpExpEM1Test_b_1_q;
    reg [9:0] redist2_fracHalf_uid91_fpExpEM1Test_b_1_q;
    reg [0:0] redist3_expXZ_uid82_fpExpEM1Test_q_9_q;
    reg [0:0] redist4_prodNorm_uid78_fpExpEM1Test_b_1_q;
    reg [16:0] redist6_fracPreMult_uid71_fpExpEM1Test_b_1_q;
    reg [6:0] redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_q;
    reg [6:0] redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_0;
    reg [6:0] redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_1;
    reg [6:0] redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_2;
    reg [6:0] redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_3;
    reg [9:0] redist9_fracX_uid7_fpExpEM1Test_b_1_q;
    reg [4:0] redist10_expX_uid6_fpExpEM1Test_b_1_q;
    reg [9:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_outputreg0_q;
    wire redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_reset0;
    wire [9:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ia;
    wire [1:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_aa;
    wire [1:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ab;
    wire [9:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_iq;
    wire [9:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_q;
    wire [1:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_q;
    (* preserve *) reg [1:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_i;
    reg [1:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_wraddr_q;
    wire [2:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_last_q;
    wire [2:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_b;
    wire [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_q;
    reg [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmpReg_q;
    wire [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_notEnable_q;
    wire [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_nor_q;
    (* dont_merge *) reg [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena_q;
    wire [0:0] redist5_fracAlpha_uid74_fpExpEM1Test_b_6_enaAnd_q;
    wire redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_reset0;
    wire [4:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ia;
    wire [2:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_aa;
    wire [2:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ab;
    wire [4:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_iq;
    wire [4:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_q;
    wire [2:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_q;
    (* preserve *) reg [2:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_i;
    reg [2:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_wraddr_q;
    wire [3:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_last_q;
    wire [3:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_b;
    wire [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_q;
    reg [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmpReg_q;
    wire [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_notEnable_q;
    wire [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_nor_q;
    (* dont_merge *) reg [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena_q;
    wire [0:0] redist8_expAlpha_uid63_fpExpEM1Test_b_9_enaAnd_q;
    ...
    // redist0_outSign_uid99_fpExpEM1Test_q_11(DELAY,136)
    dspba_delay_ver #( .width(1), .depth(10), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    redist0_outSign_uid99_fpExpEM1Test_q_11 ( .xin(outSign_uid99_fpExpEM1Test_q), .xout(redist0_outSign_uid99_fpExpEM1Test_q_11_q), .clk(clk), .aclr(areset), .ena(1'b1) );

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_notEnable(LOGICAL,164)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_notEnable_q = ~ (VCC_q);

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_nor(LOGICAL,165)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_nor_q = ~ (redist8_expAlpha_uid63_fpExpEM1Test_b_9_notEnable_q | redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena_q);

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_last(CONSTANT,161)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_last_q = 4'b0110;

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp(LOGICAL,162)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_b = {1'b0, redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_q};
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_q = redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_last_q == redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_b ? 1'b1 : 1'b0;

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmpReg(REG,163)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmpReg_q <= 1'b0;
        end
        else
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmpReg_q <= redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmp_q;
        end
    end

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena(REG,166)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena_q <= 1'b0;
        end
        else if (redist8_expAlpha_uid63_fpExpEM1Test_b_9_nor_q == 1'b1)
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena_q <= redist8_expAlpha_uid63_fpExpEM1Test_b_9_cmpReg_q;
        end
    end

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_enaAnd(LOGICAL,167)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_enaAnd_q = redist8_expAlpha_uid63_fpExpEM1Test_b_9_sticky_ena_q & VCC_q;

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt(COUNTER,159)
    // low=0, high=7, step=1, init=0
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_i <= 3'd0;
        end
        else
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_i <= $unsigned(redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_i) + $unsigned(3'd1);
        end
    end
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_q = redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_i[2:0];

    // expAlpha_uid63_fpExpEM1Test(BITSELECT,62)@0
    assign expAlpha_uid63_fpExpEM1Test_b = a[14:10];

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_wraddr(REG,160)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_wraddr_q <= 3'b111;
        end
        else
        begin
            redist8_expAlpha_uid63_fpExpEM1Test_b_9_wraddr_q <= redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_q;
        end
    end

    // redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem(DUALMEM,158)
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ia = expAlpha_uid63_fpExpEM1Test_b;
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_aa = redist8_expAlpha_uid63_fpExpEM1Test_b_9_wraddr_q;
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ab = redist8_expAlpha_uid63_fpExpEM1Test_b_9_rdcnt_q;
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_reset0 = areset;
    altera_syncram #(
        .ram_block_type("MLAB"),
    ...
    ) redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_dmem (
        .clocken1(redist8_expAlpha_uid63_fpExpEM1Test_b_9_enaAnd_q[0]),
        .clocken0(1'b1),
        .clock0(clk),
        .aclr1(redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_reset0),
        .clock1(clk),
        .address_a(redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_aa),
        .data_a(redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ia),
        .wren_a(VCC_q[0]),
        .address_b(redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_ab),
        .q_b(redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_iq),
        .wren_b(),
        .rden_a(),
        .rden_b(),
        .data_b(),
    ...
    assign redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_q = redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_iq[4:0];

    // expAlphaZ_uid84_fpExpEM1Test(LOGICAL,83)@9 + 1
    assign expAlphaZ_uid84_fpExpEM1Test_qi = redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_q != 5'b00000 ? 1'b1 : 1'b0;
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    expAlphaZ_uid84_fpExpEM1Test_delay ( .xin(expAlphaZ_uid84_fpExpEM1Test_qi), .xout(expAlphaZ_uid84_fpExpEM1Test_q), .clk(clk), .aclr(areset), .ena(1'b1) );

    // expAlphaZ_uid85_fpExpEM1Test(LOGICAL,84)@10
    ...
    // redist10_expX_uid6_fpExpEM1Test_b_1(DELAY,146)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist10_expX_uid6_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist10_expX_uid6_fpExpEM1Test_b_1_q <= expX_uid6_fpExpEM1Test_b;
        end
    end

    // expXZ_uid82_fpExpEM1Test(LOGICAL,81)@1 + 1
    assign expXZ_uid82_fpExpEM1Test_qi = redist10_expX_uid6_fpExpEM1Test_b_1_q != 5'b00000 ? 1'b1 : 1'b0;
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    ...
    // redist3_expXZ_uid82_fpExpEM1Test_q_9(DELAY,139)
    dspba_delay_ver #( .width(1), .depth(8), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    redist3_expXZ_uid82_fpExpEM1Test_q_9 ( .xin(expXZ_uid82_fpExpEM1Test_q), .xout(redist3_expXZ_uid82_fpExpEM1Test_q_9_q), .clk(clk), .aclr(areset), .ena(1'b1) );

    // expXZ_uid83_fpExpEM1Test(LOGICAL,82)@10
    assign expXZ_uid83_fpExpEM1Test_q = ~ (redist3_expXZ_uid82_fpExpEM1Test_q_9_q);

    // expAlphaP1_uid65_fpExpEM1Test(ADD,64)@9 + 1
    assign expAlphaP1_uid65_fpExpEM1Test_a = {1'b0, redist8_expAlpha_uid63_fpExpEM1Test_b_9_mem_q};
    assign expAlphaP1_uid65_fpExpEM1Test_b = {5'b00000, VCC_q};
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            expAlphaP1_uid65_fpExpEM1Test_o <= 6'b0;
        end
        else
        begin
            expAlphaP1_uid65_fpExpEM1Test_o <= $unsigned(expAlphaP1_uid65_fpExpEM1Test_a) + $unsigned(expAlphaP1_uid65_fpExpEM1Test_b);
        end
    end
    assign expAlphaP1_uid65_fpExpEM1Test_q = expAlphaP1_uid65_fpExpEM1Test_o[5:0];

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_notEnable(LOGICAL,154)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_notEnable_q = ~ (VCC_q);

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_nor(LOGICAL,155)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_nor_q = ~ (redist5_fracAlpha_uid74_fpExpEM1Test_b_6_notEnable_q | redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena_q);

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_last(CONSTANT,151)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_last_q = 3'b010;

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp(LOGICAL,152)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_b = {1'b0, redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_q};
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_q = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_last_q == redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_b ? 1'b1 : 1'b0;

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmpReg(REG,153)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmpReg_q <= 1'b0;
        end
        else
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmpReg_q <= redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmp_q;
        end
    end

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena(REG,156)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena_q <= 1'b0;
        end
        else if (redist5_fracAlpha_uid74_fpExpEM1Test_b_6_nor_q == 1'b1)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena_q <= redist5_fracAlpha_uid74_fpExpEM1Test_b_6_cmpReg_q;
        end
    end

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_enaAnd(LOGICAL,157)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_enaAnd_q = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_sticky_ena_q & VCC_q;

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt(COUNTER,149)
    // low=0, high=3, step=1, init=0
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_i <= 2'd0;
        end
        else
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_i <= $unsigned(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_i) + $unsigned(2'd1);
        end
    end
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_q = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_i[1:0];

    // fracAlpha_uid74_fpExpEM1Test(BITSELECT,73)@0
    assign fracAlpha_uid74_fpExpEM1Test_b = a[9:0];

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_wraddr(REG,150)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_wraddr_q <= 2'b11;
        end
        else
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_wraddr_q <= redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_q;
        end
    end

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem(DUALMEM,148)
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ia = fracAlpha_uid74_fpExpEM1Test_b;
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_aa = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_wraddr_q;
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ab = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_rdcnt_q;
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_reset0 = areset;
    altera_syncram #(
        .ram_block_type("MLAB"),
        .operation_mode("DUAL_PORT"),
        .width_a(10),
        ...
        .power_up_uninitialized("TRUE"),
        .intended_device_family("Arria 10")
    ) redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_dmem (
        .clocken1(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_enaAnd_q[0]),
        .clocken0(1'b1),
        .clock0(clk),
        .aclr1(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_reset0),
        .clock1(clk),
        .address_a(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_aa),
        .data_a(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ia),
        .wren_a(VCC_q[0]),
        .address_b(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_ab),
        .q_b(redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_iq),
        .wren_b(),
        .rden_a(),
        .rden_b(),
        .data_b(),
    ...
    assign redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_q = redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_iq[9:0];

    // redist5_fracAlpha_uid74_fpExpEM1Test_b_6_outputreg0(DELAY,147)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_outputreg0_q <= '0;
        end
        else
        begin
            redist5_fracAlpha_uid74_fpExpEM1Test_b_6_outputreg0_q <= redist5_fracAlpha_uid74_fpExpEM1Test_b_6_mem_q;
        end
    end

    // mantAlpha_uid76_fpExpEM1Test(BITJOIN,75)@6
    assign mantAlpha_uid76_fpExpEM1Test_q = {VCC_q, redist5_fracAlpha_uid74_fpExpEM1Test_b_6_outputreg0_q};

    // cstBiasSingleOffset_uid57_fpExpEM1Test(CONSTANT,56)
    assign cstBiasSingleOffset_uid57_fpExpEM1Test_q = 7'b1110000;

    // expXSP_uid58_fpExpEM1Test(ADD,57)@1
    assign expXSP_uid58_fpExpEM1Test_a = {3'b000, redist10_expX_uid6_fpExpEM1Test_b_1_q};
    ...
    // redist9_fracX_uid7_fpExpEM1Test_b_1(DELAY,145)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist9_fracX_uid7_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist9_fracX_uid7_fpExpEM1Test_b_1_q <= fracX_uid7_fpExpEM1Test_b;
        end
    end
    ...
    // fracXSP_uid60_fpExpEM1Test(BITJOIN,59)@1
    assign fracXSP_uid60_fpExpEM1Test_q = {redist9_fracX_uid7_fpExpEM1Test_b_1_q, cstZeroExtSPFrac_uid59_fpExpEM1Test_q};

    // posX_uid61_fpExpEM1Test(BITJOIN,60)@1
    assign posX_uid61_fpExpEM1Test_q = {GND_q, expXSP_uid58_fpExpEM1Test_q, fracXSP_uid60_fpExpEM1Test_q};

    // tabSelTable_uid21_fpExpEM1Test(LOOKUP,20)@1
    always @(redist10_expX_uid6_fpExpEM1Test_b_1_q)
    begin
        // Begin reserved scope level
        unique case (redist10_expX_uid6_fpExpEM1Test_b_1_q)
    ...
    // rightShiftStage1_uid125_a_uid12_fpExpEM1Test(MUX,124)@0 + 1
    ...
    begin
        if (areset)
        begin
            rightShiftStage1_uid125_a_uid12_fpExpEM1Test_q <= 13'b0;
        end
        else
        begin
    ...
    // newaDs0_uid25_fpExpEM1Test_merged_bit_select(BITSELECT,134)@1
    ...
    // bb4_uid43_fpExpEM1Test(BITJOIN,42)@1
    ...
    // aa4_uid50_fpExpEM1Test(LOOKUP,49)@1
    ...
    // selectBitsC_uid15_fpExpEM1Test(BITSELECT,14)@1
    ...
    // newaCs_uid19_fpExpEM1Test(LOOKUP,18)@1
    ...
    // newaCs0_uid24_fpExpEM1Test_merged_bit_select(BITSELECT,133)@1
    ...
    // bb3_uid40_fpExpEM1Test(BITJOIN,39)@1
    ...
    // aa3_uid49_fpExpEM1Test(LOOKUP,48)@1
    ...
    // selectBitsB_uid14_fpExpEM1Test(BITSELECT,13)@1
    ...
    // newaBs_uid18_fpExpEM1Test(LOOKUP,17)@1
    ...
    // newaBs0_uid23_fpExpEM1Test_merged_bit_select(BITSELECT,132)@1
    ...
    // selectBitsA_uid13_fpExpEM1Test(BITSELECT,12)@1
    ...
    // newaAs_uid17_fpExpEM1Test(LOOKUP,16)@1
    ...
    // newaAs0_uid22_fpExpEM1Test_merged_bit_select(BITSELECT,131)@1
    ...
    // bb2_uid36_fpExpEM1Test(BITJOIN,35)@1
    ...
    // aa2_uid48_fpExpEM1Test(LOOKUP,47)@1
    ...
    // bb1_uid31_fpExpEM1Test(BITJOIN,30)@1
    ...
    // aa1_uid47_fpExpEM1Test(LOOKUP,46)@1
    ...
    // bb0_uid26_fpExpEM1Test(BITJOIN,25)@1
    ...
    // aa0_uid46_fpExpEM1Test(LOOKUP,45)@1
    ...
    // addr_uid52_fpExpEM1Test(BITJOIN,51)@1
    ...
    // c1u_uid54_fpExpEM1Test(LOOKUP,53)@1
    ...
    begin
        ...
        unique case (addr_uid52_fpExpEM1Test_q)
            ...
            6'b011101 : c1u_uid54_fpExpEM1Test_q = 32'b11110011101010110010011111110000;
    ...
    // c0u_uid53_fpExpEM1Test(LOOKUP,52)@1
    always @(addr_uid52_fpExpEM1Test_q)
    begin
        // Begin reserved scope level
        unique case (addr_uid52_fpExpEM1Test_q)
            ...
            6'b011101 : c0u_uid53_fpExpEM1Test_q = 32'b00011101000010000011000101110000;
    ...
    // fpPEOutRaw_uid62_fpExpEM1Test_impl(FPCOLUMN,126)@1
    // out q0@5
    ...
    twentynm_fp_mac #(
        ...
        .aclr({ fpPEOutRaw_uid62_fpExpEM1Test_impl_reset0, fpPEOutRaw_uid62_fpExpEM1Test_impl_reset0 }),
    ...
    // expPEOut_uid66_fpExpEM1Test_merged_bit_select(BITSELECT,135)@5
    ...
    // fracPreMult_uid71_fpExpEM1Test(BITSELECT,70)@5
    assign fracPreMult_uid71_fpExpEM1Test_b = expPEOut_uid66_fpExpEM1Test_merged_bit_select_c[22:6];

    // redist6_fracPreMult_uid71_fpExpEM1Test_b_1(DELAY,142)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist6_fracPreMult_uid71_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist6_fracPreMult_uid71_fpExpEM1Test_b_1_q <= fracPreMult_uid71_fpExpEM1Test_b;
        end
    end

    // mantPreMult_uid73_fpExpEM1Test(BITJOIN,72)@6
    assign mantPreMult_uid73_fpExpEM1Test_q = {VCC_q, redist6_fracPreMult_uid71_fpExpEM1Test_b_1_q};

    // GND(CONSTANT,0)
    assign GND_q = 1'b0;

    // prodMant_uid77_fpExpEM1Test_cma(CHAINMULTADD,129)@6 + 3
    ...
    assign prodMant_uid77_fpExpEM1Test_cma_a0 = mantPreMult_uid73_fpExpEM1Test_q;
    assign prodMant_uid77_fpExpEM1Test_cma_c0 = mantAlpha_uid76_fpExpEM1Test_q;
    twentynm_mac #(
        ...
        .aclr({ prodMant_uid77_fpExpEM1Test_cma_reset, prodMant_uid77_fpExpEM1Test_cma_reset }),
    ...
    dspba_delay_ver #( .width(29), .depth(0), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    ...
    // redist4_prodNorm_uid78_fpExpEM1Test_b_1(DELAY,140)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist4_prodNorm_uid78_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist4_prodNorm_uid78_fpExpEM1Test_b_1_q <= prodNorm_uid78_fpExpEM1Test_b;
        end
    end
    ...
    // secondRndTerm_uid89_fpExpEM1Test(BITJOIN,88)@10
    assign secondRndTerm_uid89_fpExpEM1Test_q = {expAlphaP1_uid65_fpExpEM1Test_q, redist4_prodNorm_uid78_fpExpEM1Test_b_1_q, cstonewfp1_uid88_fpExpEM1Test_q};

    // expPEOutRange7_uid67_fpExpEM1Test(BITSELECT,66)@5
    ...
    // redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5(DELAY,143)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_0 <= '0;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_1 <= '0;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_2 <= '0;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_3 <= '0;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_q <= '0;
        end
        else
        begin
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_0 <= expPEOutRange7_uid67_fpExpEM1Test_b;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_1 <= redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_0;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_2 <= redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_1;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_3 <= redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_2;
            redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_q <= redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_delay_3;
        end
    end

    // expPEOutOne_uid69_fpExpEM1Test(BITJOIN,68)@10
    assign expPEOutOne_uid69_fpExpEM1Test_q = {VCC_q, redist7_expPEOutRange7_uid67_fpExpEM1Test_b_5_q};
    ...
    // prodPreRnd_uid81_fpExpEM1Test(MUX,80)@9 + 1
    assign prodPreRnd_uid81_fpExpEM1Test_s = prodNorm_uid78_fpExpEM1Test_b;
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            prodPreRnd_uid81_fpExpEM1Test_q <= 11'b0;
        end
        else
        begin
    ...
    // udf0_uid92_fpExpEM1Test(BITSELECT,91)@10
    ...
    // udf_uid93_fpExpEM1Test(LOGICAL,92)@10 + 1
    assign udf_uid93_fpExpEM1Test_qi = udf0_uid92_fpExpEM1Test_b | expXZ_uid83_fpExpEM1Test_q | expAlphaZ_uid85_fpExpEM1Test_q;
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("ASYNC"), .phase(0), .modulus(1) )
    udf_uid93_fpExpEM1Test_delay ( .xin(udf_uid93_fpExpEM1Test_qi), .xout(udf_uid93_fpExpEM1Test_q), .clk(clk), .aclr(areset), .ena(1'b1) );

    // notUdf_uid94_fpExpEM1Test(LOGICAL,93)@11
    assign notUdf_uid94_fpExpEM1Test_q = ~ (udf_uid93_fpExpEM1Test_q);

    // expHalfPreUdf_uid95_fpExpEM1Test(BITSELECT,94)@10
    ...
    // redist1_expHalfPreUdf_uid95_fpExpEM1Test_b_1(DELAY,137)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist1_expHalfPreUdf_uid95_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist1_expHalfPreUdf_uid95_fpExpEM1Test_b_1_q <= expHalfPreUdf_uid95_fpExpEM1Test_b;
        end
    end

    // expHalf_uid96_fpExpEM1Test(LOGICAL,95)@11
    assign expHalf_uid96_fpExpEM1Test_b = {{4{notUdf_uid94_fpExpEM1Test_q[0]}}, notUdf_uid94_fpExpEM1Test_q};
    assign expHalf_uid96_fpExpEM1Test_q = redist1_expHalfPreUdf_uid95_fpExpEM1Test_b_1_q & expHalf_uid96_fpExpEM1Test_b;

    // fracHalf_uid91_fpExpEM1Test(BITSELECT,90)@10
    ...
    // redist2_fracHalf_uid91_fpExpEM1Test_b_1(DELAY,138)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist2_fracHalf_uid91_fpExpEM1Test_b_1_q <= '0;
        end
        else
        begin
            redist2_fracHalf_uid91_fpExpEM1Test_b_1_q <= fracHalf_uid91_fpExpEM1Test_b;
        end
    end

    // fpOutPEHalf_uid100_fpExpEM1Test(BITJOIN,99)@11
    assign fpOutPEHalf_uid100_fpExpEM1Test_q = {redist0_outSign_uid99_fpExpEM1Test_q_11_q, expHalf_uid96_fpExpEM1Test_q, redist2_fracHalf_uid91_fpExpEM1Test_b_1_q};
