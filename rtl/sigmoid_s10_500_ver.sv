...
// SystemVerilog created from sigmoid_s10_500_ver
// SystemVerilog created on Mon Oct 22 16:58:44 2018

// LATENCY=8

(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module sigmoid_s10_500_ver (
    input wire [15:0] a,
    output wire [15:0] q,
    input wire clk,
    input wire areset
    ...
    wire [7:0] expXPostZero_uid31_fpSigmoid_qi;
    reg [7:0] expXPostZero_uid31_fpSigmoid_q;
    ...
    reg [5:0] redist0_r_uid77_a_uid14_fpSigmoid_q_2_q;
    reg [0:0] redist1_nanOut_uid50_fpSigmoid_q_6_q;
    reg [0:0] redist1_nanOut_uid50_fpSigmoid_q_6_delay_0;
    reg [0:0] redist1_nanOut_uid50_fpSigmoid_q_6_delay_1;
    reg [0:0] redist1_nanOut_uid50_fpSigmoid_q_6_delay_2;
    reg [0:0] redist1_nanOut_uid50_fpSigmoid_q_6_delay_3;
    reg [0:0] redist2_signFPPEOut_uid46_fpSigmoid_b_1_q;
    reg [4:0] redist3_expPEOutForHalfRange_uid45_fpSigmoid_b_1_q;
    reg [9:0] redist4_fracFPPEOutHalfRange_uid44_fpSigmoid_b_1_q;
    reg [0:0] redist5_gte8Abs_uid21_fpSigmoid_n_6_q;
    reg [0:0] redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_0;
    reg [0:0] redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_1;
    reg [0:0] redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_2;
    reg [0:0] redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_3;
    reg [0:0] redist6_signX_uid8_fpSigmoid_b_3_q;
    reg [0:0] redist6_signX_uid8_fpSigmoid_b_3_delay_0;
    reg [0:0] redist6_signX_uid8_fpSigmoid_b_3_delay_1;
    reg [0:0] redist7_signX_uid8_fpSigmoid_b_8_q;
    reg [0:0] redist7_signX_uid8_fpSigmoid_b_8_delay_0;
    reg [0:0] redist7_signX_uid8_fpSigmoid_b_8_delay_1;
    reg [0:0] redist7_signX_uid8_fpSigmoid_b_8_delay_2;
    reg [0:0] redist7_signX_uid8_fpSigmoid_b_8_delay_3;
    reg [9:0] redist8_fracX_uid7_fpSigmoid_b_1_q;
    reg [9:0] redist9_fracX_uid7_fpSigmoid_b_2_q;
    reg [9:0] redist10_fracX_uid7_fpSigmoid_b_3_q;
    reg [4:0] redist11_expX_uid6_fpSigmoid_b_2_q;
    reg [4:0] redist11_expX_uid6_fpSigmoid_b_2_delay_0;
    ...
    // redist6_signX_uid8_fpSigmoid_b_3(DELAY,88)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist6_signX_uid8_fpSigmoid_b_3_delay_0 <= signX_uid8_fpSigmoid_b;
            redist6_signX_uid8_fpSigmoid_b_3_delay_1 <= redist6_signX_uid8_fpSigmoid_b_3_delay_0;
            redist6_signX_uid8_fpSigmoid_b_3_q <= redist6_signX_uid8_fpSigmoid_b_3_delay_1;
        end
    end
    ...
    // redist11_expX_uid6_fpSigmoid_b_2(DELAY,93)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist11_expX_uid6_fpSigmoid_b_2_delay_0 <= expX_uid6_fpSigmoid_b;
            redist11_expX_uid6_fpSigmoid_b_2_q <= redist11_expX_uid6_fpSigmoid_b_2_delay_0;
        end
    end

    // expXNonZero_uid27_fpSigmoid(LOGICAL,26)@2
    assign expXNonZero_uid27_fpSigmoid_q = redist11_expX_uid6_fpSigmoid_b_2_q != 5'b00000 ? 1'b1 : 1'b0;

    // cstBiasSingleOffset_uid26_fpSigmoid(CONSTANT,25)
    assign cstBiasSingleOffset_uid26_fpSigmoid_q = 7'b1110000;

    // expXSP_uid28_fpSigmoid(ADD,27)@2
    assign expXSP_uid28_fpSigmoid_a = {3'b000, redist11_expX_uid6_fpSigmoid_b_2_q};
    ...
    // expXPostZero_uid31_fpSigmoid(LOGICAL,30)@2 + 1
    assign expXPostZero_uid31_fpSigmoid_b = {{7{expXNonZero_uid27_fpSigmoid_q[0]}}, expXNonZero_uid27_fpSigmoid_q};
    assign expXPostZero_uid31_fpSigmoid_qi = expXSP_uid28_fpSigmoid_q & expXPostZero_uid31_fpSigmoid_b;
    dspba_delay_ver #( .width(8), .depth(1), .reset_kind("NONE"), .phase(0), .modulus(1) )
    expXPostZero_uid31_fpSigmoid_delay ( .xin(expXPostZero_uid31_fpSigmoid_qi), .xout(expXPostZero_uid31_fpSigmoid_q), .clk(clk), .aclr(areset), .ena(1'b1) );

    // fracX_uid7_fpSigmoid(BITSELECT,6)@0
    assign fracX_uid7_fpSigmoid_b = a[9:0];

    // redist8_fracX_uid7_fpSigmoid_b_1(DELAY,90)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist8_fracX_uid7_fpSigmoid_b_1_q <= fracX_uid7_fpSigmoid_b;
        end
    end

    // redist9_fracX_uid7_fpSigmoid_b_2(DELAY,91)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist9_fracX_uid7_fpSigmoid_b_2_q <= redist8_fracX_uid7_fpSigmoid_b_1_q;
        end
    end

    // redist10_fracX_uid7_fpSigmoid_b_3(DELAY,92)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist10_fracX_uid7_fpSigmoid_b_3_q <= redist9_fracX_uid7_fpSigmoid_b_2_q;
        end
    end
    ...
    // fracXSP_uid30_fpSigmoid(BITJOIN,29)@3
    assign fracXSP_uid30_fpSigmoid_q = {redist10_fracX_uid7_fpSigmoid_b_3_q, cstZeroExtSPFrac_uid29_fpSigmoid_q};

    // fusedX_uid32_fpSigmoid(BITJOIN,31)@3
    assign fusedX_uid32_fpSigmoid_q = {redist6_signX_uid8_fpSigmoid_b_3_q, expXPostZero_uid31_fpSigmoid_q, fracXSP_uid30_fpSigmoid_q};
    ...
    assign top5FracX_uid9_fpSigmoid_b = redist8_fracX_uid7_fpSigmoid_b_1_q[9:5];
    ...
    assign rightShiftStage0_uid70_a_uid14_fpSigmoid_s = rightShiftStageSel0Dto0_uid69_a_uid14_fpSigmoid_merged_bit_select_b;
    ...
    // rightShiftStageSel0Dto0_uid69_a_uid14_fpSigmoid_merged_bit_select(BITSELECT,81)@1
    ...
    assign rightShiftStage1_uid75_a_uid14_fpSigmoid_s = rightShiftStageSel0Dto0_uid69_a_uid14_fpSigmoid_merged_bit_select_c;
    ...
    // shiftedOut_uid59_a_uid14_fpSigmoid(COMPARE,58)@1
    ...
    assign shiftedOut_uid59_a_uid14_fpSigmoid_o = $unsigned(shiftedOut_uid59_a_uid14_fpSigmoid_a) - $unsigned(shiftedOut_uid59_a_uid14_fpSigmoid_b);
    assign shiftedOut_uid59_a_uid14_fpSigmoid_n[0] = ~ (shiftedOut_uid59_a_uid14_fpSigmoid_o[7]);

    // r_uid77_a_uid14_fpSigmoid(MUX,76)@1 + 1
    ...
    // redist0_r_uid77_a_uid14_fpSigmoid_q_2(DELAY,82)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist0_r_uid77_a_uid14_fpSigmoid_q_2_q <= r_uid77_a_uid14_fpSigmoid_q;
        end
    end

    // c1un_uid17_fpSigmoid(LOOKUP,16)@3
    always @(redist0_r_uid77_a_uid14_fpSigmoid_q_2_q)
    begin
        // Begin reserved scope level
        unique case (redist0_r_uid77_a_uid14_fpSigmoid_q_2_q)
    ...
    // newas_uid15_fpSigmoid(LOOKUP,14)@2 + 1
    always @ (posedge clk)
    begin
        if (0)
        begin
    ...
    // c1up_uid19_fpSigmoid(LOOKUP,18)@3
    ...
    // coefC1Fused_uid34_fpSigmoid(MUX,33)@3
    assign coefC1Fused_uid34_fpSigmoid_s = redist6_signX_uid8_fpSigmoid_b_3_q;
    ...
    // c0un_uid16_fpSigmoid(LOOKUP,15)@3
    always @(redist0_r_uid77_a_uid14_fpSigmoid_q_2_q)
    begin
        // Begin reserved scope level
        unique case (redist0_r_uid77_a_uid14_fpSigmoid_q_2_q)
    ...
    // c0up_uid18_fpSigmoid(LOOKUP,17)@3
    always @(newas_uid15_fpSigmoid_q)
    begin
        // Begin reserved scope level
        unique case (newas_uid15_fpSigmoid_q)
    ...
    // coefC0Fused_uid33_fpSigmoid(MUX,32)@3
    assign coefC0Fused_uid33_fpSigmoid_s = redist6_signX_uid8_fpSigmoid_b_3_q;
    ...
    // fpPEOut_uid35_fpSigmoid_impl(FPCOLUMN,78)@3
    // out q0@7
    ...
    assign fpPEOut_uid35_fpSigmoid_impl_reset0 = 1'b0;
    ...
    fourteennm_fp_mac #(
        ...
        .clr({ fpPEOut_uid35_fpSigmoid_impl_reset0, fpPEOut_uid35_fpSigmoid_impl_reset0 }),
    ...
    // signFPPEOut_uid46_fpSigmoid(BITSELECT,45)@7
    assign signFPPEOut_uid46_fpSigmoid_b = fpPEOut_uid35_fpSigmoid_impl_q0[31:31];

    // redist2_signFPPEOut_uid46_fpSigmoid_b_1(DELAY,84)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist2_signFPPEOut_uid46_fpSigmoid_b_1_q <= signFPPEOut_uid46_fpSigmoid_b;
        end
    end

    // expPEOut_uid41_fpSigmoid(BITSELECT,40)@7
    assign expPEOut_uid41_fpSigmoid_b = fpPEOut_uid35_fpSigmoid_impl_q0[30:23];

    // expPEOutForHalf_uid42_fpSigmoid(SUB,41)@7
    ...
    // expPEOutForHalfRange_uid45_fpSigmoid(BITSELECT,44)@7
    ...
    // redist3_expPEOutForHalfRange_uid45_fpSigmoid_b_1(DELAY,85)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist3_expPEOutForHalfRange_uid45_fpSigmoid_b_1_q <= expPEOutForHalfRange_uid45_fpSigmoid_b;
        end
    end

    // fracFPPEOut_uid43_fpSigmoid(BITSELECT,42)@7
    assign fracFPPEOut_uid43_fpSigmoid_b = fpPEOut_uid35_fpSigmoid_impl_q0[22:0];

    // fracFPPEOutHalfRange_uid44_fpSigmoid(BITSELECT,43)@7
    assign fracFPPEOutHalfRange_uid44_fpSigmoid_b = fracFPPEOut_uid43_fpSigmoid_b[22:13];

    // redist4_fracFPPEOutHalfRange_uid44_fpSigmoid_b_1(DELAY,86)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist4_fracFPPEOutHalfRange_uid44_fpSigmoid_b_1_q <= fracFPPEOutHalfRange_uid44_fpSigmoid_b;
        end
    end

    // fpOutPEHalf_uid47_fpSigmoid(BITJOIN,46)@8
    assign fpOutPEHalf_uid47_fpSigmoid_q = {redist2_signFPPEOut_uid46_fpSigmoid_b_1_q, redist3_expPEOutForHalfRange_uid45_fpSigmoid_b_1_q, redist4_fracFPPEOutHalfRange_uid44_fpSigmoid_b_1_q};

    // redist7_signX_uid8_fpSigmoid_b_8(DELAY,89)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist7_signX_uid8_fpSigmoid_b_8_delay_0 <= redist6_signX_uid8_fpSigmoid_b_3_q;
            redist7_signX_uid8_fpSigmoid_b_8_delay_1 <= redist7_signX_uid8_fpSigmoid_b_8_delay_0;
            redist7_signX_uid8_fpSigmoid_b_8_delay_2 <= redist7_signX_uid8_fpSigmoid_b_8_delay_1;
            redist7_signX_uid8_fpSigmoid_b_8_delay_3 <= redist7_signX_uid8_fpSigmoid_b_8_delay_2;
            redist7_signX_uid8_fpSigmoid_b_8_q <= redist7_signX_uid8_fpSigmoid_b_8_delay_3;
        end
    end
    ...
    // gte8Abs_uid21_fpSigmoid(COMPARE,20)@2 + 1
    assign gte8Abs_uid21_fpSigmoid_a = {2'b00, redist11_expX_uid6_fpSigmoid_b_2_q};
    ...
    // redist5_gte8Abs_uid21_fpSigmoid_n_6(DELAY,87)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_0 <= gte8Abs_uid21_fpSigmoid_n;
            redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_1 <= redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_0;
            redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_2 <= redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_1;
            redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_3 <= redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_2;
            redist5_gte8Abs_uid21_fpSigmoid_n_6_q <= redist5_gte8Abs_uid21_fpSigmoid_n_6_delay_3;
        end
    end

    // finalResSel_uid40_fpSigmoid(BITJOIN,39)@8
    assign finalResSel_uid40_fpSigmoid_q = {redist7_signX_uid8_fpSigmoid_b_8_q, redist5_gte8Abs_uid21_fpSigmoid_n_6_q};

    // finalRes_uid51_fpSigmoid(MUX,50)@8
    ...
    // expNotZero_uid48_fpSigmoid(LOGICAL,47)@2
    assign expNotZero_uid48_fpSigmoid_q = redist9_fracX_uid7_fpSigmoid_b_2_q != 10'b0000000000 ? 1'b1 : 1'b0;

    // expAllOne_uid49_fpSigmoid(LOGICAL,48)@2
    assign expAllOne_uid49_fpSigmoid_q = redist11_expX_uid6_fpSigmoid_b_2_q == 5'b11111 ? 1'b1 : 1'b0;

    // nanOut_uid50_fpSigmoid(LOGICAL,49)@2 + 1
    ...
    // redist1_nanOut_uid50_fpSigmoid_q_6(DELAY,83)
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            redist1_nanOut_uid50_fpSigmoid_q_6_delay_0 <= nanOut_uid50_fpSigmoid_q;
            redist1_nanOut_uid50_fpSigmoid_q_6_delay_1 <= redist1_nanOut_uid50_fpSigmoid_q_6_delay_0;
            redist1_nanOut_uid50_fpSigmoid_q_6_delay_2 <= redist1_nanOut_uid50_fpSigmoid_q_6_delay_1;
            redist1_nanOut_uid50_fpSigmoid_q_6_delay_3 <= redist1_nanOut_uid50_fpSigmoid_q_6_delay_2;
            redist1_nanOut_uid50_fpSigmoid_q_6_q <= redist1_nanOut_uid50_fpSigmoid_q_6_delay_3;
        end
    end
    ...
    // finalResPostNaN_uid54_fpSigmoid(MUX,53)@8
    assign finalResPostNaN_uid54_fpSigmoid_s = redist1_nanOut_uid50_fpSigmoid_q_6_q;
