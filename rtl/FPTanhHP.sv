...
// SystemVerilog created from FPTanhHP
// SystemVerilog created on Tue Jul 24 21:41:35 2018
...
module FPTanhHP (
    ...
    wire [7:0] expXPostZero_uid27_fpTanhTest_q;
    ...
    wire [0:0] expAllOne_uid46_fpTanhTest_q;
    ...
    reg [1:0] redist0_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b_1_q;
    reg [0:0] redist1_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c_1_q;
    reg [0:0] redist2_nanOut_uid47_fpTanhTest_q_4_q;
    reg [0:0] redist2_nanOut_uid47_fpTanhTest_q_4_delay_0;
    reg [0:0] redist2_nanOut_uid47_fpTanhTest_q_4_delay_1;
    reg [0:0] redist3_gte4Abs_uid19_fpTanhTest_n_4_q;
    reg [0:0] redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_0;
    reg [0:0] redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_1;
    reg [0:0] redist4_signX_uid8_fpTanhTest_b_5_q;
    reg [0:0] redist4_signX_uid8_fpTanhTest_b_5_delay_0;
    reg [0:0] redist4_signX_uid8_fpTanhTest_b_5_delay_1;
    reg [0:0] redist4_signX_uid8_fpTanhTest_b_5_delay_2;
    reg [0:0] redist4_signX_uid8_fpTanhTest_b_5_delay_3;
    reg [9:0] redist5_fracX_uid7_fpTanhTest_b_1_q;
    reg [4:0] redist6_expX_uid6_fpTanhTest_b_1_q;

    import FPTanhHP_safe_path_ver::safe_path_ver;
    ...
    // redist4_signX_uid8_fpTanhTest_b_5(DELAY,93)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist4_signX_uid8_fpTanhTest_b_5_delay_0 <= '0;
            redist4_signX_uid8_fpTanhTest_b_5_delay_1 <= '0;
            redist4_signX_uid8_fpTanhTest_b_5_delay_2 <= '0;
            redist4_signX_uid8_fpTanhTest_b_5_delay_3 <= '0;
            redist4_signX_uid8_fpTanhTest_b_5_q <= '0;
        end
        else
        begin
            redist4_signX_uid8_fpTanhTest_b_5_delay_0 <= signX_uid8_fpTanhTest_b;
            redist4_signX_uid8_fpTanhTest_b_5_delay_1 <= redist4_signX_uid8_fpTanhTest_b_5_delay_0;
            redist4_signX_uid8_fpTanhTest_b_5_delay_2 <= redist4_signX_uid8_fpTanhTest_b_5_delay_1;
            redist4_signX_uid8_fpTanhTest_b_5_delay_3 <= redist4_signX_uid8_fpTanhTest_b_5_delay_2;
            redist4_signX_uid8_fpTanhTest_b_5_q <= redist4_signX_uid8_fpTanhTest_b_5_delay_3;
        end
    end
    ...
    // redist6_expX_uid6_fpTanhTest_b_1(DELAY,95)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist6_expX_uid6_fpTanhTest_b_1_q <= '0;
        end
        else
        begin
            redist6_expX_uid6_fpTanhTest_b_1_q <= expX_uid6_fpTanhTest_b;
        end
    end

    // expXNonZero_uid23_fpTanhTest(LOGICAL,22)@1
    assign expXNonZero_uid23_fpTanhTest_q = redist6_expX_uid6_fpTanhTest_b_1_q != 5'b00000 ? 1'b1 : 1'b0;

    // expXSP_uid24_fpTanhTest(ADD,23)@1
    assign expXSP_uid24_fpTanhTest_a = {3'b000, redist6_expX_uid6_fpTanhTest_b_1_q};
    ...
    // expXPostZero_uid27_fpTanhTest(LOGICAL,26)@1
    assign expXPostZero_uid27_fpTanhTest_b = {{7{expXNonZero_uid23_fpTanhTest_q[0]}}, expXNonZero_uid23_fpTanhTest_q};
    assign expXPostZero_uid27_fpTanhTest_q = expXSP_uid24_fpTanhTest_q & expXPostZero_uid27_fpTanhTest_b;

    // fracX_uid7_fpTanhTest(BITSELECT,6)@0
    assign fracX_uid7_fpTanhTest_b = a[9:0];

    // redist5_fracX_uid7_fpTanhTest_b_1(DELAY,94)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist5_fracX_uid7_fpTanhTest_b_1_q <= '0;
        end
        else
        begin
            redist5_fracX_uid7_fpTanhTest_b_1_q <= fracX_uid7_fpTanhTest_b;
        end
    end
    ...
    // fracXSP_uid26_fpTanhTest(BITJOIN,25)@1
    assign fracXSP_uid26_fpTanhTest_q = {redist5_fracX_uid7_fpTanhTest_b_1_q, cstZeroExtSPFrac_uid25_fpTanhTest_q};

    // posX_uid28_fpTanhTest(BITJOIN,27)@1
    ...
    assign top5FracX_uid9_fpTanhTest_b = redist5_fracX_uid7_fpTanhTest_b_1_q[9:5];
    ...
    // shiftValue_uid13_fpTanhTest(SUB,12)@0
    ...
    assign shiftValue_uid13_fpTanhTest_o = $unsigned(shiftValue_uid13_fpTanhTest_a) - $unsigned(shiftValue_uid13_fpTanhTest_b);
    assign shiftValue_uid13_fpTanhTest_q = shiftValue_uid13_fpTanhTest_o[5:0];

    // rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select(BITSELECT,87)@0
    ...
    // redist0_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b_1(DELAY,89)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist0_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b_1_q <= '0;
        end
        else
        begin
            redist0_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b_1_q <= rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b;
        end
    end

    // rightShiftStage0_uid76_a_uid14_fpTanhTest(MUX,75)@1
    assign rightShiftStage0_uid76_a_uid14_fpTanhTest_s = redist0_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_b_1_q;
    ...
    // redist1_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c_1(DELAY,90)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist1_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c_1_q <= '0;
        end
        else
        begin
            redist1_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c_1_q <= rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c;
        end
    end

    // rightShiftStage1_uid81_a_uid14_fpTanhTest(MUX,80)@1
    assign rightShiftStage1_uid81_a_uid14_fpTanhTest_s = redist1_rightShiftStageSel0Dto0_uid75_a_uid14_fpTanhTest_merged_bit_select_c_1_q;
    ...
    // shiftedOut_uid65_a_uid14_fpTanhTest(COMPARE,64)@0 + 1
    ...
    begin
        if (areset)
        begin
            shiftedOut_uid65_a_uid14_fpTanhTest_o <= 8'b0;
        end
        else
        begin
            shiftedOut_uid65_a_uid14_fpTanhTest_o <= $unsigned(shiftedOut_uid65_a_uid14_fpTanhTest_a) - $unsigned(shiftedOut_uid65_a_uid14_fpTanhTest_b);
        end
    end
    assign shiftedOut_uid65_a_uid14_fpTanhTest_n[0] = ~ (shiftedOut_uid65_a_uid14_fpTanhTest_o[7]);

    // r_uid83_a_uid14_fpTanhTest(MUX,82)@1
    assign r_uid83_a_uid14_fpTanhTest_s = shiftedOut_uid65_a_uid14_fpTanhTest_n;
    always @(r_uid83_a_uid14_fpTanhTest_s or rightShiftStage1_uid81_a_uid14_fpTanhTest_q or zeroOutCst_uid82_a_uid14_fpTanhTest_q)
    begin
    ...
    // newas_uid15_fpTanhTest(LOOKUP,14)@1
    ...
    // c1u_uid17_fpTanhTest(LOOKUP,16)@1
    ...
    // c0u_uid16_fpTanhTest(LOOKUP,15)@1
    always @(newas_uid15_fpTanhTest_q)
    begin
        // Begin reserved scope level
        unique case (newas_uid15_fpTanhTest_q)
    ...
    // fpPEOutRaw_uid29_fpTanhTest_impl(FPCOLUMN,84)@1
    // out q0@5
    ...
    assign fpPEOutRaw_uid29_fpTanhTest_impl_reset0 = areset;
    ...
    twentynm_fp_mac #(
        ...
        .aclr({ fpPEOutRaw_uid29_fpTanhTest_impl_reset0, fpPEOutRaw_uid29_fpTanhTest_impl_reset0 }),
    ...
    // expPEOut_uid35_fpTanhTest_merged_bit_select(BITSELECT,88)@5
    ...
    // expPEOutPForHalf_uid36_fpTanhTest(SUB,35)@5
    ...
    // udf_uid37_fpTanhTest(BITSELECT,36)@5
    ...
    // udf_uid38_fpTanhTest(LOGICAL,37)@5
    assign udf_uid38_fpTanhTest_q = ~ (udf_uid37_fpTanhTest_b);

    // expHalfNoFilter_uid39_fpTanhTest(BITSELECT,38)@5
    ...
    // expPostPotentialUdf_uid42_fpTanhTest(LOGICAL,41)@5
    assign expPostPotentialUdf_uid42_fpTanhTest_b = {{4{udf_uid38_fpTanhTest_q[0]}}, udf_uid38_fpTanhTest_q};
    assign expPostPotentialUdf_uid42_fpTanhTest_q = expHalfNoFilter_uid39_fpTanhTest_b & expPostPotentialUdf_uid42_fpTanhTest_b;

    // fracPostPotentialUdf_uid41_fpTanhTest(BITSELECT,40)@5
    assign fracPostPotentialUdf_uid41_fpTanhTest_b = expPEOut_uid35_fpTanhTest_merged_bit_select_c[22:13];

    // fpOutPEHalf_uid44_fpTanhTest(BITJOIN,43)@5
    assign fpOutPEHalf_uid44_fpTanhTest_q = {redist4_signX_uid8_fpTanhTest_b_5_q, expPostPotentialUdf_uid42_fpTanhTest_q, fracPostPotentialUdf_uid41_fpTanhTest_b};

    // cst17_uid18_fpTanhTest(CONSTANT,17)
    assign cst17_uid18_fpTanhTest_q = 5'b10001;

    // gte4Abs_uid19_fpTanhTest(COMPARE,18)@1 + 1
    assign gte4Abs_uid19_fpTanhTest_a = {2'b00, redist6_expX_uid6_fpTanhTest_b_1_q};
    assign gte4Abs_uid19_fpTanhTest_b = {2'b00, cst17_uid18_fpTanhTest_q};
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            gte4Abs_uid19_fpTanhTest_o <= 7'b0;
        end
        else
        begin
    ...
    // redist3_gte4Abs_uid19_fpTanhTest_n_4(DELAY,92)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_0 <= '0;
            redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_1 <= '0;
            redist3_gte4Abs_uid19_fpTanhTest_n_4_q <= '0;
        end
        else
        begin
            redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_0 <= gte4Abs_uid19_fpTanhTest_n;
            redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_1 <= redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_0;
            redist3_gte4Abs_uid19_fpTanhTest_n_4_q <= redist3_gte4Abs_uid19_fpTanhTest_n_4_delay_1;
        end
    end

    // finalResSel_uid34_fpTanhTest(BITJOIN,33)@5
    assign finalResSel_uid34_fpTanhTest_q = {redist4_signX_uid8_fpTanhTest_b_5_q, redist3_gte4Abs_uid19_fpTanhTest_n_4_q};

    // VCC(CONSTANT,1)
    assign VCC_q = 1'b1;

    // finalRes_uid48_fpTanhTest(MUX,47)@5
    ...
    // signFinalRes_uid59_fpTanhTest(BITSELECT,58)@5
    assign signFinalRes_uid59_fpTanhTest_b = finalRes_uid48_fpTanhTest_q[15:15];

    // expNotZero_uid45_fpTanhTest(LOGICAL,44)@1
    assign expNotZero_uid45_fpTanhTest_q = redist5_fracX_uid7_fpTanhTest_b_1_q != 10'b0000000000 ? 1'b1 : 1'b0;

    // expAllOne_uid46_fpTanhTest(LOGICAL,45)@1
    assign expAllOne_uid46_fpTanhTest_q = redist6_expX_uid6_fpTanhTest_b_1_q == 5'b11111 ? 1'b1 : 1'b0;

    // nanOut_uid47_fpTanhTest(LOGICAL,46)@1 + 1
    ...
    // redist2_nanOut_uid47_fpTanhTest_q_4(DELAY,91)
    always @ (posedge clk or posedge areset)
    begin
        if (areset)
        begin
            redist2_nanOut_uid47_fpTanhTest_q_4_delay_0 <= '0;
            redist2_nanOut_uid47_fpTanhTest_q_4_delay_1 <= '0;
            redist2_nanOut_uid47_fpTanhTest_q_4_q <= '0;
        end
        else
        begin
            redist2_nanOut_uid47_fpTanhTest_q_4_delay_0 <= nanOut_uid47_fpTanhTest_q;
            redist2_nanOut_uid47_fpTanhTest_q_4_delay_1 <= redist2_nanOut_uid47_fpTanhTest_q_4_delay_0;
            redist2_nanOut_uid47_fpTanhTest_q_4_q <= redist2_nanOut_uid47_fpTanhTest_q_4_delay_1;
        end
    end

    // expFinalRes_uid49_fpTanhTest(BITSELECT,48)@5
    ...
    // expFinalRes4_uid56_fpTanhTest(BITSELECT,55)@5
    assign expFinalRes4_uid56_fpTanhTest_b = expFinalRes_uid49_fpTanhTest_b[4:4];

    // msbExpPostNan_uid57_fpTanhTest(LOGICAL,56)@5
    assign msbExpPostNan_uid57_fpTanhTest_q = expFinalRes4_uid56_fpTanhTest_b | redist2_nanOut_uid47_fpTanhTest_q_4_q;

    // expFinalRes3to0_uid55_fpTanhTest(BITSELECT,54)@5
    ...
    // fracFinalRes9to1_uid53_fpTanhTest(BITSELECT,52)@5
    assign fracFinalRes9to1_uid53_fpTanhTest_b = fracFinalRes_uid50_fpTanhTest_b[9:1];

    // fracFinalRes0_uid51_fpTanhTest(BITSELECT,50)@5
    ...
    // fracFinalResLSB_uid52_fpTanhTest(LOGICAL,51)@5
    assign fracFinalResLSB_uid52_fpTanhTest_q = fracFinalRes0_uid51_fpTanhTest_b | redist2_nanOut_uid47_fpTanhTest_q_4_q;

    // fracFinalPostNan_uid54_fpTanhTest(BITJOIN,53)@5
    assign fracFinalPostNan_uid54_fpTanhTest_q = {fracFinalRes9to1_uid53_fpTanhTest_b, fracFinalResLSB_uid52_fpTanhTest_q};

    // finalResPostNaN_uid60_fpTanhTest(BITJOIN,59)@5
